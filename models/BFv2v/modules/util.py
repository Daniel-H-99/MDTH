...
from BFv2v.sync_batchnorm import SynchronizedBatchNorm2d as BatchNorm2d
from BFv2v.sync_batchnorm import SynchronizedBatchNorm3d as BatchNorm3d
...
def kp2gaussian(kp, spatial_size, kp_variance):
    ...
    coordinate_grid = make_coordinate_grid(spatial_size, mean.type()).to(device)
    ...
    # print(f'coordinate grid device: {coordinate_grid.device}')
