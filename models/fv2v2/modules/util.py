...
class AdaIn(nn.Module):
    def __init__(self, condition_dim, num_output, hidden_dim=128, depth=2):
        ...
        self.hidden_dim=hidden_dim
        self.condition_encoder = LinearEncoder(input_dim=self.condition_dim, latent_dim=self.hidden_dim, output_dim=2*self.num_output, depth=self.depth)
    ...
    def normalize(self, x, params):
        ...
        return params[:, 0].unsqueeze(1) + normed_x * params[:, 1].unsqueeze(1)
