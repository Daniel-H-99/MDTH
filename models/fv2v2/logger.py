...
class Visualizer:
    ...
    def visualize(self, driving, source, out):
        ...
        if 'kp_source_cycled' in out:
            ...
            prediction_cycled = out['prediction_cycled'].data.cpu().numpy()
            prediction_cycled = np.transpose(prediction_cycled, [0, 2, 3, 1])
            images.append((prediction_cycled, kp_source_cycled))
